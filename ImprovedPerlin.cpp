...
/** \file
		\brief Implements the noise1 to noise4 functions for Perlin noise.
 ...
 * (although I cleaned it up, made it faster and made the code
 * more readable), but the 1D, 2D and 4D cases were implemented
 * from scratch by me.
 *
 ...
 */
 ...
 /*
	 This code has been modified by Kacper Kuryllo for better use with C++.
	 The original author can be found referenced above and holds credit for
	 the original work.
 */
